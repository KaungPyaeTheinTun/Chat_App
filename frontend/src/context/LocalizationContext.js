...
const translations = {
  en: {
    ...
    groupsTitle: "Groups",
    groupsSubtitle: "Your group conversations in one place.",
    groupsEmpty: "No group conversations yet.",
    ...
    chatEdit: "Edit",
    chatCopy: "Copy",
    chatCopied: "Message copied.",
    chatUnableCopy: "Unable to copy message.",
    chatReply: "Reply",
    chatForward: "Forward",
    chatReplyingTo: "Replying to message",
    chatReplyingToPreview: "Replying to",
    chatCancelReply: "Cancel reply",
    chatForwarded: "Forwarded",
    chatForwardTo: "Forward to",
    chatForwardedSuccess: "Message forwarded.",
    chatForwardedManySuccess: "Message forwarded to {{count}} chats.",
    chatUnableForward: "Unable to forward message.",
  ...
  mm: {
    ...
    groupsTitle: "Groups",
    groupsSubtitle: "သင့် group conversations များကို တစ်နေရာတည်းတွင် ကြည့်ပါ။",
    groupsEmpty: "Group conversation မရှိသေးပါ။",
    groupsCreate: "Group ဖန်တီးမည်",
    ...
    chatEdit: "ပြင်မည်",
    chatCopy: "Copy",
    chatCopied: "Message ကို copy ကူးပြီးပါပြီ။",
    chatUnableCopy: "Message copy ကူး၍ မရပါ။",
    chatReply: "Reply",
    chatForward: "Forward",
    chatReplyingTo: "Message ကို reply ပြန်ထားသည်",
    chatReplyingToPreview: "Reply ပြန်မည်",
    chatCancelReply: "Reply ပယ်မည်",
    chatForwarded: "Forwarded",
    chatForwardTo: "Forward ပို့မည်",
    chatForwardedSuccess: "Message forward ပို့ပြီးပါပြီ။",
    chatForwardedManySuccess:
      "Message ကို chat {{count}} ခုသို့ forward ပို့ပြီးပါပြီ။",
    chatUnableForward: "Message forward ပို့၍ မရပါ။",
